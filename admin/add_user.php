...
<head>
    ...
    <title>Add User - Pneumonia Detection System</title>
    ...
    <div class="dashboard-container">
        <div class="form-container">
            ...
            <div class="form-inner">
                ...
                <?php endif; ?>
                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="addUserForm" onsubmit="return validateForm()">
                    ...
                    <div class="form-group">
                        ...
                        <select id="role" name="role" required oninput="validateRole(this)">
                            <option value="user" <?php echo isset($input_role) && $input_role == 'user' ? 'selected' : ''; ?>>User</option>
                            <option value="admin" <?php echo isset($input_role) && $input_role == 'admin' ? 'selected' : ''; ?>>Admin</option>
                        </select>
